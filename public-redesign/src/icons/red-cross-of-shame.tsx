...
const RedCrossofShameIcon: any = pure(svg);
RedCrossofShameIcon.displayName = "RedCrossofShameIcon";
RedCrossofShameIcon.muiName = "SvgIcon";

export default RedCrossofShameIcon;
