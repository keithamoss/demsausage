...
export default function AddStall(props: Props) {
  ...
  const [startTimeValue, setStartTimeValue] = React.useState<Moment | null>(
    null
  );
  ...
  const step1Content = (
    <React.Fragment>
      <Typography variant="body1" gutterBottom>
        Please complete the form below to add your stall to the map. Please do
        not submit entries that are offensive, political or do not relate to an
        election day stall. Please also make sure that you have authorisation to
        run your fundraising event at the polling place. All entries are
    ...
    <Root>
      ...
      <PageWrapper>
        ...
        >
          ...
          <Step>
            <StepLabel
              optional={<Typography variant="caption">My stall</Typography>}
            >
              Who's submitting?
            </StepLabel>
            <StepContent>
