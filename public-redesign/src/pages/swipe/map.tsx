  ...
  const mapSearchResultsArray = [
    {
      ...
      extent: [
        144.90931227679806, -37.79525859266615, 144.9531919227886,
        -37.75317190681365,
      ] as any,
    ...
    },
    {
      ...
      lat: -37.9169381,
      extent: [
        145.3531296040862, -38.010189690473965, 145.54602434367877,
        -37.81607099611173,
      ] as any,
      formattedAddress: "Foobar foobar",
    },
    ...
    <OpenLayersMap
      ...
      mapSearchResults={
        mapSearchResults != null
          ? (mapSearchResultsArray[mapSearchResults] as IMapSearchResults)
          : null
      }
