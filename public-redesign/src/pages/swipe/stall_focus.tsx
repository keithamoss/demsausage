        ...
        <Card variant="outlined" sx={{ border: 0 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2">
              Family and Friends of South Melbourne Park Primary bring you a
              lakeside BBQ and baked goods Bonanza
            </Typography>
            <Typography variant="body2">
              Our P & F Association will be holding a sausage sizzle, selling
              snags in Bakers Delight bread, bacon and eggs rolls and drinks.
              PLUS we will be having a huge cake stall AND craft stall. Don't
              miss out! 122 Jasper Road, Bentleigh (entry from Higgins Road)
            </Typography>
            ...
            <List dense sx={{ paddingBottom: 0, paddingTop: 0 }}>
              <ListItem disableGutters>
                ...
                <ListItemText
                  primary="Noms"
                  secondary="sausage sizzle, cake stall, bacon and egg burgers"
                />
              </ListItem>
              ...
              <ListItem disableGutters>
                ...
                <ListItemText
                  primary="Entrance"
                  secondary="Access via Aughtie Drive"
                />
              </ListItem>
              <ListItem disableGutters>
                <ListItemIcon>
                ...
                <ListItemText
                  primary="Wheelchair Access"
                  secondary="Assisted wheelchair access"
                />
              </ListItem>
              <ListItem disableGutters>
                <ListItemIcon>
