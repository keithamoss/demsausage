...
export default function BottomDrawer(props: Props) {
  ...
  const [focussedStallId, setFocussedStallId] = React.useState<number | null>(
    null
  );
  ...
  const StyledInteractableBox = open
    ? StyledInteractableBoxFullHeight
    : StyledInteractableBoxMinimised;
          ...
          {stallFocussed === true && focussedStallId !== null && (
            <StyledInteractableBoxForStallFocus>
              <StallFocus
                ...
                focussedStallId={focussedStallId}
              />
            </StyledInteractableBoxForStallFocus>
          )}
