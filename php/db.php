...
$pendingStallsAllowedFields = array("stall_name", "stall_description", "stall_website", "contact_email", "has_bbq", "has_caek", "has_vego", "has_halal", "polling_place_id", "polling_place_premises", "elections_id");
...
function fetchPendingStalls() {
  ...
  $stmt = $file_db->query("SELECT * FROM pending_stalls");
  $stalls = [];
