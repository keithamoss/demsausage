...
class MediaPage extends React.Component<TComponentProps, IStateProps> {
  render() {
    return (
      <React.Fragment>
        <Helmet>
          <title>Democracy Sausage | Media</title>

          {/* Open Graph / Facebook / Twitter */}
          <meta property="og:url" content={`${getBaseURL()}/media`} />
          <meta property="og:title" content="Democracy Sausage | Media" />
        </Helmet>
          ...
          <List>
            ...
            <ListItem
              ...
              containerElement={
                ...
                <a href="/media/2022%20Federal%20Election%20Media%20Release%20-%2010%20Apr.pdf" />
              }
            />
            <ListItem
