...
def polling_place_with_an_approved_owner_submission_and_a_new_tip_off_with_free_text_noms():
    pollingPlace = get_next_polling_place(
        "Approved owner submission and a new tip-off with free text noms"
    )
    ...
    create_tipoff_stall(
        ...
        "",
        {"bbq": True, "free_text": "And cats! Free cats!"},
    )
...
# polling_place_with_an_approved_owner_submission_and_a_new_tip_off_with_free_text_noms()
