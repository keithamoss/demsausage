...
# Avoids needlessly regenerating the GeoJSON data each time we insert a new polling place
print("Setting Status = Active: {} updated".format(PollingPlaces.objects.all().update(status=PollingPlaceStatus.ACTIVE)))
