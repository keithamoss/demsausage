...
const routes = (store: IStore) => {
  return (
    <Route path="/" component={AppContainer}>
      ...
      <Route
        path="/elections"
        components={{ content: ElectionsManagerContainer }}
      />
      <Route
        path="/election/new"
        components={{ content: ElectionCreatorContainer }}
      />
      <Route
        path="/election/:electionIdentifier/load_polling_places"
        components={{ content: ElectionPollingPlaceLoaderContainer }}
      />
      <Route
        path="/election/:electionIdentifier"
        components={{ content: ElectionEditorContainer }}
      />
      ...
      <Route
        ...
        components={{ content: PollingPlaceTypesEditorContainer }}
      />

      {/* Stalls Routes */}
      <Route
        path="/stalls"
        components={{ content: PendingStallsManagerContainer }}
      />
      <Route
        path="/stalls(/:stallId)"
        components={{ content: PendingStallEditorContainer }}
      />
    </Route>
  );
};
