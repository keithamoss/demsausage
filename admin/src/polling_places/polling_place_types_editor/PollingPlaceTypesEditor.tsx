            ...
            <div key={index} style={style}>
              <GridBox>
                ...
                <div>
                  ...
                  >
                    {pollingPlaceTypes.map((type: string) => <RadioButton key={type} value={type} label={type} style={styles.radio} />)}
                  </RadioButtonGroup>
                </div>
                <div>
                  <RaisedButton
                    ...
                    containerElement={
                      <CustomLink to={`https://www.google.com.au/search?q=${pollingPlacesSansType[index].premises}`} target="_blank" />
                    }
                  />
                </div>
              </GridBox>
