...
import DjangoAPIErrorUI, {
  IDjangoAPIError,
} from "../../shared/ui/DjangoAPIErrorUI/DjangoAPIErrorUI";
  ...
  render(): any {
    ...
    return (
      <Field
        ...
        thumbStyle={{ backgroundColor: grey100 }}
        {...rest}
      />
    );
  }
              ...
              <div>
                <FormSection style={{ marginTop: 0 }}>
                  ...
                  <CustomTextField
                    ...
                    component={TextField}
                    floatingLabelText={
                      "Stall website or social media page (optional)"
                    }
                    hintText={
                ...
                <FormSection>
                  ...
                  <List>
                    ...
                    <ListItem
                      ...
                      rightToggle={
                        <DeliciousnessToggle name="bacon_and_eggs" />
                      }
                    />
                  </List>
                ...
                <FormSection>
                  ...
                  <CustomTextField
                    ...
                    hintText={
                      "So we can let you know when we've approved your stall"
                    }
                    fullWidth={true}
                ...
                <PrivacySection>
                  ...
                  <Privacy>
                    Democracy Sausage loves open data, but we also love privacy
                    and not sharing your data with anyone who shouldn't have it.
                    Without access to open (i.e. publicly available, reusable,
                    and free) polling place data from the electoral commissions
                    Democracy Sausage wouldn't exist, so where we can we like to
                    share the data we crowdsauce as open data for others to use.
                    <br />
                    <br />
                    For some elections we'll allow third parties to display
                    information submitted to Democracy Sausage on their websites
                    - e.g. local media outlets who want to show a map of sausage
                    sizzles, other election sausage sizzle mapping sites, or
                    companies and political parties running "Where to vote"
                    websites who want to show people where to find sausage
                    sizzles. Democracy Sausage is 100% volunteer-run because we
                    love the idea of mapping sausage sizzles - we{" "}
                    <strong>never</strong> benefit financially or personally
                    from these arrangements.
                    <br />
                    <br />
                    We'll allow these third parties to use information about
                    your stall (
                    <strong>
                      its name, a description of it, and any website address
                    </strong>
                    ) and what you have on offer (
                    <strong>
                      whether there's a sausage sizzle, cake stall, et cetera
                    </strong>
                    ). We <strong>won't</strong> tell these third parties
                    anything about you (the person who is submitting this
                    stall), this includes{" "}
                    <strong>
                      your email, IP address, and any other personally
                      identifiable information that your phone or laptop
                      transmits to us
                    </strong>
                    . All of the information about where your stall actually is
                    comes from the electoral commissions and is already publicly
                    available.
                    <br />
                    <br />
                    Got questions or concerns about any of this? Just get in
                    touch with us at{" "}
