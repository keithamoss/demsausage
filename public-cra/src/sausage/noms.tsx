...
export class NomsReader {
    ...
    public getIconForNoms(spriteIcons: any) {
        ...
        } else if (this.isPropertyTrue("cake") === true) {
            if (this.isPropertyTrue("run_out") === true) {
    ...
    public getDetailedIconsForNoms(spriteIcons: any, spriteIconsDetailed: any, feature: IMapPollingPlaceFeature, resolution: number) {
        ...
        let primaryIconName = this.getPrimaryIconName()
    ...
    public getPrimaryIconName() {
        if (this.hasRunOut() === true) {
            return "run_out"
        } else if (this.hasExtraNoms() === true) {
            return "plus"
        }
        return "tick"
    }
