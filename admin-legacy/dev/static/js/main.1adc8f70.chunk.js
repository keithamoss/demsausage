		...
		1949: function (e, t, n) {
								...
								value: function () {
									...
									return Object(Ot.jsx)(Mt.a, {
										...
										children: Object(Ot.jsx)(kt, {
											providerName: 'Google',
											providerUrl: ''.concat('https://admin.test.democracysausage.org/api', '/login/google-oauth2/'),
											colour: '#DD4B39',
										}),
									});
								},
											...
											null !== t &&
												Object(Ot.jsxs)($e.Fragment, {
													children: [
														...
														Object(Ot.jsx)('img', {
															src: ''
																.concat('https://admin.test.democracysausage.org/api', '/0.1/map_image/')
																.concat(t.id, '/'),
														}),
													],
												}),
						...
						return {
							...
							onDownloadElection: function (e) {
								window.location.href = ''
									.concat('https://admin.test.democracysausage.org/api', '/0.1/polling_places/?format=csv&election_id=')
									.concat(e.id);
							},
			...
			var mc,
				...
				ds = (function () {
					function e() {
						Object(Ge.a)(this, e),
							(this.baseURL = void 0),
							(this.baseURL = 'https://admin.test.democracysausage.org/api');
					}
					return (
						Object(We.a)(e, [
							{
			...
			'REACT_APP_RAVEN_URL' in
				Object({
					...
					REACT_APP_API_BASE_URL: 'https://admin.test.democracysausage.org/api',
					...
					REACT_APP_SITE_BASE_URL: 'https://admin.test.democracysausage.org',
				}) &&
				(c.a({
